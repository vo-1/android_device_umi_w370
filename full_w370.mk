...
$(call inherit-product, device/umi/w370/device.mk)
...
KERNEL_DEFCONFIG ?= w370_debug_defconfig
else
KERNEL_DEFCONFIG ?= w370_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= w370
LK_PROJECT ?= w370
TRUSTY_PROJECT ?= w370
