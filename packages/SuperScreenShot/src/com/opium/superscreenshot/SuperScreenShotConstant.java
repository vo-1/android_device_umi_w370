...
public class SuperScreenShotConstant {
	...
	public interface Intent {
		public static final String LONG_SCREEN_SHOT_ACTION = "com.opium.longss.action.window";
		public static final String HOME_SCREEN_SHOT_ACTION = "com.opium.home.action.window";
		public static final String FUNS_SCREEN_SHOT_ACTION = "com.opium.funs.action.window";
		public static final String NORMAL_SCREEN_SHOT_ACTION = "com.opium.normal.action.window";
	}
